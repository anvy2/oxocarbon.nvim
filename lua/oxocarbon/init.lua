...
vim.api.nvim_set_hl(0, "Identifier", {fg = oxocarbon.base05, bg = oxocarbon.none})
vim.api.nvim_set_hl(0, "Include", {fg = oxocarbon.base10, bg = oxocarbon.none})
vim.api.nvim_set_hl(0, "Keyword", {fg = oxocarbon.base10, bg = oxocarbon.none})
vim.api.nvim_set_hl(0, "Label", {fg = oxocarbon.base10, bg = oxocarbon.none})
vim.api.nvim_set_hl(0, "Number", {fg = oxocarbon.base15, bg = oxocarbon.none})
vim.api.nvim_set_hl(0, "Operator", {fg = oxocarbon.base10, bg = oxocarbon.none})
vim.api.nvim_set_hl(0, "PreProc", {fg = oxocarbon.base10, bg = oxocarbon.none})
vim.api.nvim_set_hl(0, "Repeat", {fg = oxocarbon.base10, bg = oxocarbon.none})
vim.api.nvim_set_hl(0, "Special", {fg = oxocarbon.base05, bg = oxocarbon.none})
vim.api.nvim_set_hl(0, "SpecialChar", {fg = oxocarbon.base05, bg = oxocarbon.none})
vim.api.nvim_set_hl(0, "SpecialComment", {fg = oxocarbon.base09, bg = oxocarbon.none})
vim.api.nvim_set_hl(0, "Statement", {fg = oxocarbon.base10, bg = oxocarbon.none})
vim.api.nvim_set_hl(0, "StorageClass", {fg = oxocarbon.base10, bg = oxocarbon.none})
vim.api.nvim_set_hl(0, "String", {fg = oxocarbon.base15, bg = oxocarbon.none})
vim.api.nvim_set_hl(0, "Structure", {fg = oxocarbon.base10, bg = oxocarbon.none})
vim.api.nvim_set_hl(0, "Tag", {fg = oxocarbon.base05, bg = oxocarbon.none})
vim.api.nvim_set_hl(0, "Todo", {fg = oxocarbon.base14, bg = oxocarbon.none})
vim.api.nvim_set_hl(0, "Type", {fg = oxocarbon.base10, bg = oxocarbon.none})
vim.api.nvim_set_hl(0, "Typedef", {fg = oxocarbon.base10, bg = oxocarbon.none})
